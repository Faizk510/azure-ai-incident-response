...
# Timer-based log analysis pipeline from the earlier lab phase
# Queries recent application logs, sends them to Ollama for analysis, and writes AI insights to the Log Analytics.
...
"""
    ...
    try:
        ai_response = requests.post(ollama_url, json=payload, timeout=180)
